...
func apply_customization_settings(config: ConfigFile) -> void:
	...
	PlayerCustomization.player_colors[0][0] = config.get_value("players", "p1_color_0", CustomizationManager.default_colors[0][0])
	PlayerCustomization.player_colors[0][1] = config.get_value("players", "p1_color_1", CustomizationManager.default_colors[0][1])
	PlayerCustomization.player_colors[0][2] = config.get_value("players", "p1_color_2", CustomizationManager.default_colors[0][2])
	PlayerCustomization.player_colors[0][3] = config.get_value("players", "p1_color_3", CustomizationManager.default_colors[0][3])

	PlayerCustomization.player_colors[1][0] = config.get_value("players", "p2_color_0", CustomizationManager.default_colors[1][0])
	PlayerCustomization.player_colors[1][1] = config.get_value("players", "p2_color_1", CustomizationManager.default_colors[1][1])
	PlayerCustomization.player_colors[1][2] = config.get_value("players", "p2_color_2", CustomizationManager.default_colors[1][2])
	PlayerCustomization.player_colors[1][3] = config.get_value("players", "p2_color_3", CustomizationManager.default_colors[1][3])
