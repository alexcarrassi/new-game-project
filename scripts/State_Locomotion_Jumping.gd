...
func enter(previous_state_path: String, data: Dictionary) -> void:
	...
	self.body.velocity.y = -self.body.jump_force
...
func physics_update(delta: float) -> void:
	...
	var targetSpeed = body.max_run_speed * inputState.haxis
	...
	body.velocity.y = clamp(body.velocity.y, -body.max_rise_speed, body.max_fall_speed)
